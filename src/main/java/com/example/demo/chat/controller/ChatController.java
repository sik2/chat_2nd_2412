...
import com.example.demo.config.dto.RsData;
...
public class ChatController {
    ...
    public RsData<ChatListResponse> getChatList(
        ...
        return new RsData("200", "채팅 리스트 가져오기 성공", new ChatListResponse(chats));
    }

    @PostMapping
    @ResponseBody
    public RsData<Chat> writeChat(@PathVariable("roomId") Long roomId, @RequestBody CreateChatRequest createChatRequest) {
        ...
        return new RsData("200", "채팅 작성 성공", new ChatResponse(cm));
    }
}
